---
name: dev
description: Custom Claude Copilot skill for picking the highest priority task and implementing it with TDD, security scanning, and browser-based E2E testing
whenToUse:
...
**If findings exist:**
- Fix each finding
- Re-run tests to make sure fixes don't break anything
- Re-run semgrep to confirm findings are resolved
